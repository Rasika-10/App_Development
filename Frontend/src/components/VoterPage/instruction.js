  ...
  const [isChecked, setIsChecked] = useState(false);
    ...
    return (  
        ...
        <div className="border-instruct">
           ...
           {/* <span style={{ display: "flex", alignItems: "center",paddingLeft:"320px" }}>
              {" "}
              <Checkbox />
              <Typography sx={{ fontSize: "15px",fontStyle:"serif"}}>
                {" "}
        ...
        <div className="button-instruct">
            <div className="con">
             <Link to="/ballot">  <button type="submit">
              Continue
            </button></Link>
           </div>
        </div>
